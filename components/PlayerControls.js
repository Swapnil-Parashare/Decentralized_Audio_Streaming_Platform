...
const PlayerControls = ({songs}) => {
  ...
  const { currentSong, isPlaying, volume, onVolumeChange, timestamp, progress, playNext, playPrevious, isPaused, play, pause, onProgressChange } = useContext(AudioContext);
